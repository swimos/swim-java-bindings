...
public class SwimServerBuilder extends AbstractSwimServerBuilder {
  private SwimServerBuilder(Map<String, AgentFactory<? extends AbstractAgent>> agentFactories, PlaneSchema<?> schema) {
    super(agentFactories, schema);
  }

  public static <P extends AbstractPlane> SwimServerBuilder forPlane(Class<P> planeClass) throws SwimServerException {
