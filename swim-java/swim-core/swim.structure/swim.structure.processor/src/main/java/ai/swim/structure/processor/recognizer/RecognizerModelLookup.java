...
public class RecognizerModelLookup implements ModelLookup {

  @Override
  public Model lookup(TypeMirror typeMirror, ScopedContext context) {
    return RecognizerModel.from(typeMirror, context);
  }

  @Override
  public Model untyped(TypeMirror type) {
    return new UntypedModel(type, UNTYPED_RECOGNIZER);
  }
