...
public class RecognizerContext extends Context<RecognizerTypeInitializer, RecognizerNameFormatter> {
  private RecognizerContext(Element root, ProcessingEnvironment processingEnvironment, String name, PackageElement packageElement, RecognizerTypeInitializer initializer) {
    super(root, processingEnvironment, initializer, new RecognizerNameFormatter(name, packageElement));
  }

  public static RecognizerContext build(Element root, ProcessingEnvironment processingEnvironment, ModelInspector inspector, String name, PackageElement packageElement) {
