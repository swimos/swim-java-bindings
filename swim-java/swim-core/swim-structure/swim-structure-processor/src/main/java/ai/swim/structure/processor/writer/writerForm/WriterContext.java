...
public class WriterContext extends Context<WriterTypeInitializer, WriterNameFormatter> {
  private WriterContext(Element root, ProcessingEnvironment processingEnvironment, String name, PackageElement packageElement, WriterTypeInitializer initializer) {
    super(root, processingEnvironment, initializer, new WriterNameFormatter(name, packageElement));
  }

  public static WriterContext build(Element root, ProcessingEnvironment processingEnvironment, String name, PackageElement packageElement) {
