...
public class FfiIntrinsicRegistrationFeature implements Feature {
  ...
  public void beforeAnalysis(BeforeAnalysisAccess access) {
    ...
    JNIRuntimeAccess.register(Consumer.class);

    try {
      JNIRuntimeAccess.register(CountDownLatch.class.getDeclaredMethod("countDown"));
      JNIRuntimeAccess.register(CountDownLatch.class.getDeclaredMethod("await"));
      JNIRuntimeAccess.register(Consumer.class.getDeclaredMethod("accept", Object.class));
    } catch (NoSuchMethodException e) {
      throw new NativeResourceException(e);
    }
  }
